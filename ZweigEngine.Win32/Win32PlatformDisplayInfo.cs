...
public class Win32PlatformDisplayInfo : IPlatformDisplayInfo, IDisposable
{
    private readonly DXGIFactory m_factory;

    public Win32PlatformDisplayInfo(PlatformLibraryLoader libraryLoader, IWin32DPIScalingHandler _)
    {
